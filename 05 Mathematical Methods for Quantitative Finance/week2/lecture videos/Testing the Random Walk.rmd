...
# NA: one less return than we do prices. So if we want things to line up, the return corresponding to our very first price is not available because we don't know the price before that.
...
get a rough idea without the precise statistical analysis
